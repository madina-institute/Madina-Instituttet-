/* SIST-ENDRET: 2026-08-17 12:47:54 */
// ═══════════════════════════════════════════════════════════════════
...
window.startSide = function(){
  ...
  sjekkInAppBrowser();
  // Merkene bor i stempler.js. 🔴 Grunnen de ble skilt ut: skjemaet
  // (index2.html) trenger dem, men laster ikke denne filen — det har
  // ingen språkbytte, ingen toppbar og ingen tekster fra innhold.js.
  // Å la skjemaet laste hele fellesfilen for førti linjer ville dratt
  // inn et språkbytte skjemaet ikke har, og som ville forsøkt å snu
  // siden til arabisk hvis familien valgte arabisk på prissiden.
  if(typeof visStempler === 'function') visStempler();
};
