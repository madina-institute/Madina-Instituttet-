...
const checks = [
  ...
  ['webhook pending fallback for balance', indexJs.includes('løst balance-betaling fra pendingVippsPayments')],
  ['recordStudentBalancePaymentIfNeeded helper', indexJs.includes('function recordStudentBalancePaymentIfNeeded')],
